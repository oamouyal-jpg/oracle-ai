    ...
    <div className="mx-auto max-w-2xl space-y-6">
      ...
      <GlassCard glow className="space-y-4 border-violet-400/15">
        <VoiceTextarea
          ...
          placeholder={t("clarity.weekDumpPlaceholder")}
          rows={12}
          disabled={loading}
          className="min-h-[280px] resize-none rounded-xl border border-white/10 bg-black/20 px-4 py-3 text-base leading-relaxed text-zinc-100 placeholder:text-zinc-600 outline-none focus:border-violet-400/40"
        />
